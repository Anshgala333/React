        ...
        <div className="left-parent">
            <ul className="lefticons1">
                <li>
                    ...
                    <div className="plus">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <path d="M9 3.75V14.25" stroke="#2800FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M3.75 9H14.25" stroke="#2800FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </div>
                </li>
                <li>
                    ...
                    <span className="tittle">Planning</span>
                    <div className="plus">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <path d="M9 3.75V14.25" stroke="#2800FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M3.75 9H14.25" stroke="#2800FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <li>
                    <div>
                        ...
                        <span className="tittle">Trips</span>
                        <div className="plus">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                <path d="M9 3.75V14.25" stroke="#2800FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M3.75 9H14.25" stroke="#2800FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <li className="selected">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                        <path d="M12 2.25H0.75V12H12V2.25Z" stroke="#6D7885" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M12 6H15L17.25 8.25V12H12V6Z" stroke="#6D7885" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M4.125 15.75C5.16053 15.75 6 14.9105 6 13.875C6 12.8395 5.16053 12 4.125 12C3.08947 12 2.25 12.8395 2.25 13.875C2.25 14.9105 3.08947 15.75 4.125 15.75Z" stroke="#6D7885" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M13.875 15.75C14.9105 15.75 15.75 14.9105 15.75 13.875C15.75 12.8395 14.9105 12 13.875 12C12.8395 12 12 12.8395 12 13.875C12 14.9105 12.8395 15.75 13.875 15.75Z" stroke="#6D7885" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <span className="tittle">Masters</span>
                    <div className="plus">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <path d="M9 3.75V14.25" stroke="#2800FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M3.75 9H14.25" stroke="#2800FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <li>
                    ...
                    <span className="tittle">Invoice</span>
                    <div className="plus">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <path d="M9 3.75V14.25" stroke="#2800FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M3.75 9H14.25" stroke="#2800FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <li>
                    ...
                    <span className="tittle">Reports</span>
                    <div className="plus">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <path d="M9 3.75V14.25" stroke="#2800FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M3.75 9H14.25" stroke="#2800FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <li>
                    ...
                    <span className="tittle">Control Tower</span>
                    <div className="plus">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <path d="M9 3.75V14.25" stroke="#2800FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M3.75 9H14.25" stroke="#2800FC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
